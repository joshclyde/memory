...
This application allows me to make flashcards!

Eventually, I would like to re-brand the flashcards as memories and allow many different ways to review (e.g. fill in the blank)
...
- revamping flashcard creation
  - create tags when creating new flashcard
  - sorted/grouped tags
  - compact tags
  - be able to view existing flashcards while making new ones
  - think about how the edit flashcard page will compare to this (currently in medium priority)
- delete flashcards
...
Eventually, I will want to do an entire re-design of the site. Might even rewrite it in React. But right now my focus is on easy to use functionality for personal use. In addition, I don't want to do any serious re-designing while I'm constantly deciding on new features.
